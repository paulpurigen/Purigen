...
$sql = "select pkid, type, startyear, startmonth, startday, endyear, endmonth, endday, maintitle, subtitle, url, location1, location2, booth, thumbnail1 
        from events where status = 1 order by startyear asc, startmonth asc, startday asc ";
...
<div id="container" style="overflow-x: hidden;">
    <div class="contents-visual contents-visual-events">
        ...
        <div class="featured-event">
            ...
            <h3>AMP 2019</h3>
            <div class="featured-event-booth">BOOTH 3139</div>
            <div class="featured-event-location">Baltimore, MD</div>
            <div class="featured-event-date">November 7 – 9, 2019</div>
    ...
    <div id="contents" class="contents-pd0">
        <div class="contents-title">
            <div class="contents-tab">
                <ul>
                    <li class="active"><a href="/news-events/events/list.php">upcoming</a></li>
                    <li><a href="#">past</a></li>
                </ul>
            </div>
        ...
        <div class="upcoming-event">
            ...
            <?=$webhelper->GetPageHtml($pageList, $page, "/news-events/events/list.php", $Parameter, $PageSize)?>
        </div>
        <!-- //events -->
    </div>
    <!-- //contents -->
