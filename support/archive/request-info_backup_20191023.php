...
<style>
    ...
    .pop_data{position:relative;margin:0 auto;padding:50px;width:500px;height:150px;background:#fff;border:1px solid #c9c9c9;box-sizing:border-box;text-align:left;}

    .btn_pop_close{display:block;position:absolute;right:0;top:0;width:28px;height:28px;border-left:solid 1px #e5e5e5;border-bottom:solid 1px #e5e5e5}
    ...
    <div>
        ...
        <div>
            ...
            <div class="pop_data">
                ...
                <p>Missing or incorrect information entered.</p>
