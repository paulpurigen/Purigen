...
<div id="container">
    <script type="text/javascript">
        function goUrl(type)
        {
            location.href = "/support/documentation.php?type="+type+"#a";
        }
    </script>
        ...
        <aside id="contents-aside">
            <div class="aside-category">
                ...
                <ul>
                    ...
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="1" <?=$webhelper->MakeSelectedValue("1", $type, "checked")?> onclick="goUrl('1');" id="category-specs"/> <label for="category-specs">Specification Sheets</label></div>
                    </li>
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="2" <?=$webhelper->MakeSelectedValue("2", $type, "checked")?> onclick="goUrl('2');" id="category-guides"/> <label for="category-guides">User Guides</label></div>
                    </li>
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="3" <?=$webhelper->MakeSelectedValue("3", $type, "checked")?> onclick="goUrl('3');" id="category-site-prep"/> <label for="category-site-prep">Site Prep Guides</label></div>
                    </li>
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="4" <?=$webhelper->MakeSelectedValue("4", $type, "checked")?> onclick="goUrl('4');" id="category-protocols"/> <label for="category-protocols">Protocols</label></div>
                    </li>
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="5" <?=$webhelper->MakeSelectedValue("5", $type, "checked")?> onclick="goUrl('5');" id="category-inserts"/> <label for="category-inserts">Product Inserts</label></div>
                    </li>
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="6" <?=$webhelper->MakeSelectedValue("6", $type, "checked")?> onclick="goUrl('6');" id="category-safety"/> <label for="category-safety">Safety Data Sheets</label></div>
                    </li>
                    <li>
                        <div class="checkbox-set"><input type="radio" name="type" value="7" <?=$webhelper->MakeSelectedValue("7", $type, "checked")?> onclick="goUrl('7');" id="category-term"/> <label for="category-term">Terms and Conditions</label></div>
                    </li>
                </ul>
            </div>
            <!-- //aside-category -->
        ...
        <div id="contents-section">
            <div class="contents-sorting">
                <ul>
                    ...
                    <li class="<?=$webhelper->MakeSelectedValue("6", $type, "active")?>"><a href="javascript:goUrl('6');">Safety Data Sheets</a></li>
                    <li class="<?=$webhelper->MakeSelectedValue("7", $type, "active")?>"><a href="javascript:goUrl('7');">Terms and Conditions</a></li>
                </ul>
            </div>
            <!-- //contents-sorting -->

            <div class="contents-title">
                <a id="a" style="display:block;position:relative;top:-170px;visibility:hidden;"></a>
                <h2>Documentation</h2>
            </div>
            <!-- //contents-title -->
