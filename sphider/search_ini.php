 ...
 *******************************************************************
 *
 *       Variable for additional XML and JSON output files, holding the results.
 +       Usually needs not to be modified.
 *       Activate only, if an additional XML and JSON result file should be created
 *       by each query input (search term)
 *       Default:    $out    = "";
 *       Active:      $out    = "xml";
 */
    $out        = "";
