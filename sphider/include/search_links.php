<?php
    ...
    <div class=\"mainlist\">
        ...
        <br />
        ".$sph_messages['Resfor']." \"<span class='warnadmin'>$urlquery</span>\"
        <br />
    </div>
    <br />
    ";
...
";
    ...
    ";
            ...
            ";
                ...
                echo "  <td>
                $num. <a href='$url2' target='_blank' title='Open Link in a new window'>$title</a>
            ";
                        if (!$title) {
                echo "      ".$sph_messages['notitle']."
            ";
                        }
                        echo "    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$description."
            ";
                        if (!$description) {
                            echo "  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$sph_messages['nodes']."
                        ";
                        }
                        echo "    <br />
                &nbsp;&nbsp;&nbsp;&nbsp;<a href='$url2' target='_blank' title='Open Link in a new window'>$url2</a>
                &nbsp;&nbsp;($page_size kB)
            ";

                        if ($num == 1) {
                            echo "  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='warn'>".$sph_messages['MainURL']."</span>
            ";
                        }
