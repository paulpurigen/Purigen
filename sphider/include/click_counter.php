 ...
 *******************************************************/
	...
	//	this is a special hack for the phpBB forum
    //    as it does not accept '&amp;' as part of a link to the forum
    if (stripos($url, "/forum/viewtopic.php")) {
        $url = str_replace("&amp;", "&", $url);
    }
	//    And for Zencart, likewise
	else if (stripos($url, "/index.php?main_page=")) {
		$url = str_replace("&amp;", "&", $url);
	}
