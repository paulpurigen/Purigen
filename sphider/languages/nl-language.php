<?php
    // Woorden die beginnen met '%'  worden automaties vervangen door het script. Deze woorden niet vertalen
    $sph_messages =  Array (
        ...
        "Results" => "Resultaat %from - %to van %all %matchword (%secs seconden)", //
        "match" => "treffer",     //
        "matches" => "treffers", //
        ...
        "showWarning" => "De zoekopdracht werd op deze pagina niet gevonden in de tekst maar alleen bij de trefwoorden.",
        ...
        "minutes" => "minuten",
        "noEXIF" => "Geen ID3 / EXIF info gevonden voor deze media.",
        "for" => "voor",
		...
		"order6" => "Op indexdatum en tijd",
		"LastIndexed" => "Laatst geïndexeerd:",
		"order7" => "Op aantal hits in volledige tekst",
		"MoreDomRes" => "Meer resultaten vanaf",
		"sort"  => "Methode van sorteren resultaten ",
		"t_search" => "Zoek tekst",
		"m_search" => "Zoek media" ,
		"Database" => "Database",
		"db_prefix" => "met tabelprefix",
		"contains" => "bevat",
		"sites" => "sites",
		"cats" => "categoriën",
		"links" => "links",
		...
		"hdadvanced" => "Verberg geavanceerd",
		"qfoundin" => "Query string gevonden in",
		"att" => "productattribuut",
		"atts" => "productattributen"
