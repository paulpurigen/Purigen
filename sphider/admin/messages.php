<?php
    ...
    1 => "PHP function fopen() failed to open the remote file. Also cURL library is unavailable.\n"
         ...
         "invalidCharSet" => Array (
    0 => "  <br /><span class='warn'>
                    >>> Invalid charset definition supplied via XML product feed. Unable to convert the feed into UTF-8 <<<
                    </span><br /><br />  ",
    1 => "Invalid charset definition supplied via XML product feed. Unable to convert the feed into UTF-8\n"
    ),

         "validSitemapInd" => Array (
    0 => "  <br /><span class='warnok'>
                    >>> Valid sitemap.xml index file found. <<<
                    </span><br /><br />  ",
    1 => "Valid sitemap.xml index file found.\n"
    ),
    ...
    0 => "  <br /><span class='warn'>
                    >>> Secondary sitemap.xml file found for this site, but unable to extract any links from that file. <<<
                    </span><br />",
    1 => "Invalid secondary sitemap.xml found.\nContinue index/re-index with links extracted by Sphider-plus for this site\n"
    ),
         "validPrivSitemap" => Array (
    0 => "  <br /><span class='warnok'>
                    >>> Valid private Sphider-plus sitemap.xml file found for this site. Only its content will be used to index this site.<<<
                    </span><br />  ",
    1 => "Valid private Sphider-plus sitemap.xml file found for this site.\n"
    ),
         "validSitemap" => Array (
    0 => "  <br /><span class='warnok'>
                    >>> Valid sitemap.xml file found for this site <<<
                    </span><br />  ",
    1 => "Valid sitemap.xml file found for this site.\n"
    ),
         "invalidSitemap" => Array (
    0 => "  <br /><span class='warn'>
                    >>> sitemap.xml file found for this site, but unable to extract any links from that file. <<< <br /><br />
                    >>> Continue index/re-index with links extracted by Sphider-plus for this site. <<<
                    </span><br /><br />",
    1 => "Continue index/re-index with links extracted by Sphider-plus for this site.\n"
         ...
         "too_old" => Array (
    0 => "  <br /><span class='warnok'>
                    >>> Valid sitemap.xml file found for this site, but lastmod values for all links are older than last index date. <<<
                    </span><br /><br />",
    1 => "Valid sitemap.xml file found for this site, but lastmod value is older than lsst index date.\n"
    ),
         "invalidXMLtagAmount" => Array (
    0 => "  <br /><span class='warn'>
                    >>> XML product feed does not contain enough attribute tags for a single product. <<<<br /><br />
                    >>> Unable to process this XML file. <<<
                    </span><br /><br />  ",
    1 => "XML product feed does not contain enough attribute tags for a single product.\nUnable to process this XML file.\n"
    ),
         "invalidProductFeed" => Array (
    0 => "  <br /><span class='warn'>
                    >>> Unable to extract any arguments from the XML file. Seems not to be a valid XML product feed. <<<<br /><br /></span><br /><br />  ",
    1 => "Unable to extract any links from the XML product feed. Seems not to be a valid XML product feed.\n"
    ),
    ...
    1 => " Error related to PDF permissions.\n"
         ...
         "noConverter" => Array (
    0 => " <br />\n<span class='warnadmin'>Could not find PDF converter.<br /><br />Unable to process this PDF document.<br /></span></section>\n",
    ...
    0 => "	<p><span class='red'>&nbsp;Mysql Server not avaliable! Tried 5 times to reconnect without success. Process aborted&nbsp;</font><br /><br /></p>\n
                    ...
                    <p class='evrow'><a class='bkbtn' href='admin.php?f=98' title='Go back to Admin'>Back to admin</a></p>\n",
    ...
    1 => " Continuing suspended indexing.\r\n"
          ...
          "newProducts" => Array (
    0 => "	\n<span class='bd'>\n<br /><br /><br />Products found here:<br />\n</span>\n",
    1 => " \nProducts found here:\n"
    ),
          "newKeywords" => Array (
    0 => "	\n<br /><span class='bd'>New keywords found here:</span><br />\n\n",
    1 => " \r\n\r\nNew keywords found here:\n"
    ),
          "newLinks" => Array (
    0 => "	\n<span class='bd'>\n<br />New links found here:<br />\n</span>\n",
    1 => " \nNew links found here:\n"
    ),
          "newImage" => Array (
    0 => "	\n<span class='bd'>\n<br />New images found here:<br />\n</span>\n",
    1 => " \r\n\r\nNew images files found here:\r\n"
    ),
          "newAudio" => Array (
    0 => "	\n<span class='bd'>\n<br />New audio streams found here:<br />\n</span>\n",
    1 => " \nNew audio files found here:\n"
    ),
          "newVideo" => Array (
    0 => "	\n<span class='bd'>\n<br />New videos found here:<br />\n</span>\n",
    1 => " \nNew videos files found here:\n"
    ),
          "newYoutubeVideo" => Array (
    0 => "	\n<span class='bd'>\n<br />Youtube video found here:<br />\n</span>\n",
    1 => " \nNew videos files found here:\n"
    ),
          "newFrameset" => Array (
    ...
    1 => " \nNew framesets found here:\n"
          ...
          "newIframe" => Array (
    0 => "	\n<span class='bd'>\n<br />New iframes found here:<br />\n</span>\n",
    1 => " \nNew iframes found here:\n"
    ),
          "archivFiles" => Array (
    0 => "	\n<span class='bd'>\n<br />Files found in archive:<br />\n</span>\n",
    ...
    1 => "Indexed\r\n"
          ...
          "indexed" => Array (
    0 => "\n<br /><span class='bd warnok'><br />Indexed<br /></span></section>\n",
    1 => "Indexed\r\n"
    ),
        "end_sec" => Array (
    0 => "<br /></section>\n",
    ...
    1 => " Link is unreachable.\n"
        ...
        "outofDomain" => Array (
    0 => "<span class='warnadmin'>Redirected out of domain. Indexation aborted for this URL.</span></section>\n",
    1 => " Link is unreachable.\n"
    ),
        "noCharset" => Array (
    ...
    1 => " Re-indexed\n"
        ...
        "forIP" => Array (
    0 => "	<p class='bd'>Starting for IP $remote_addr</p>\n",
    1 => "\r\nStarting for IP $remote_addr\r\n"
    ),
        "start_reindex" => Array (
    ...
    function printValidXML_pr_feed($count, $cl) {
        global $db_con, $log_format, $copy, $no_log;

        $log_msg_txt = "Valid XML product feed found here. Amount of indexed products: $count\n";
        $log_msg_html = "<span class='bd warnok'>\n<br />Indexed<br /></span>\n<span class='bd'>  Valid XML product feed found here. Amount of indexed products: $count</span><br />";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printDupReport($dup_url, $cl) {
        ...
        $log_msg_txt = "$dup_url\n";
        $log_msg_html = "<span class='warnadmin'><a href='$dup_url' target='_blank'\n	title='Open this link in new window'>$dup_url</a></span><br /><br /></section>\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printLinksReport($numoflinks, $all_links, $cl) {
        ...
        $log_msg_html = "\n<span class='bd'> Links found here: $all_links - New links: $numoflinks</span><br />\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printNotWellFormedXML($errorMessage, $cl) {
        ...
        $log_msg_html = "<br /><br /><span class='warnadmin'><strong>XML feed is not valid, reason:</strong>&nbsp;<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$errorMessage</span></section><br />\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printConverterError($FileName, $cl) {
        ...
        $log_msg_html = "<br /><span class='warnadmin sml'>Charset Converter Error. Can NOT read converter table for <strong>$FileName</strong></span><br />\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printTryHome($home_charset, $cl) {
        ...
        $log_msg_html = "<span class='warnadmin sml'>Trying to use home charset $home_charset as defined in Admin setting.</span><br /><br />\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printCanonical($cano_link, $cl) {
        ...
        $log_msg_html = "<br /><br /><span class='warnadmin'>Found a <strong>rel=\"canonical\"</strong> link tag in HTML head. Redirected to:<br /><br />$cano_link</span><br /><br /></section>\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printNoCanonical($cano_link, $cl) {
        ...
        $log_msg_html = "<br /><br /><span class='warnadmin'>Canonical link found in page header.<br /><strong>Unable to extract Redirection</strong></span><br /><br /></section>\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    <body>
        ...
        <div id='report'>
            <p class='evrow'><a class='bkbtn' href='admin.php?f=2' title='jump back to Sites view'><strong>Back to admin</strong></a>&nbsp;&nbsp;&nbsp;Abort immediately without caring about the consequences.</p>
            <br />
            <p class='evrow'><a class='bkbtn' href='admin.php?f=2&amp;cancel=1' title='Abort and jump back to Admin'><strong>Cancel this index procedure</strong></a><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database will be updated, repaired, optimized and flushed. Please remain patient, as it may take some time to work out all.</p>
            <br />
    ...
    <body>
        ...
        <br />
        <br />
        <p class='evrow'><br /><a class='bkbtn' href='admin.php?f=2&amp;cancel=1' title='Abort and jump back to Admin'><strong>Cancel all index procedures</strong></a><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database will be updated, repaired, optimized and flushed. Please remain patient, as it may take some time to work out all.</p>
        <br /><br />
    ...
    function printHeader($omit, $url, $cl) {
        ...
        $log_msg_html_link = "	<p>[Go back to <span  class='em'><a href='admin.php?f=2'>admin</a></span>]</p>";
    ...
    function printInterrupt($interrupt, $url, $cl) {
        ...
        $indexoption\n
                            <a href='admin.php?f=2' title='Go back to Admin'>Back to admin</a>\n
                            ";
    ...
    function printPageSizeReport($pageSize, $content) {
        ...
        if ($cl == 1) {
            if ($content == 'rar' || $content == 'zip') {
                ...
                $log_msg_txt = "Size of page: $pageSize"." kByte.<br /> ";
            }
        } else {
            if ($content == 'rar' || $content == 'zip') {
                $log_msg_txt = "<br />Size of extracted text from archive: $pageSize"." kByte. ";
            } else {
                $log_msg_txt = "<br />Size of page: $pageSize"." kByte. <br />";
            }
        }
    ...
    function printLanguage($lang, $cl) {
        global $db_con, $log_format, $copy, $no_log;

        if ($cl == 1) {
            $log_msg_txt = "Detected language on this page: ".$lang."\r\n";
        } else {
            $log_msg_txt = "<br />Detected language on this page: ".$lang."<br />";
        }
    ...
    function writeToLog($msg, $copy) {
        ...
        $msg = str_replace("<p class='evrow'><br /><a class='bkbtn' href='admin.php?f=2&amp;cancel=1' title='Abort and jump back to Admin'><strong>Cancel this index procedure</strong></a><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database will be updated, repaired, optimized and flushed. Please remain patient, as it may take some time to work out all.</p>", '', $msg);
        $msg = str_replace("<p class='evrow'><a class='bkbtn' href='admin.php?f=2' title='Go back to Admin'>Back to admin</a></p>", '', $msg);
        ...
        <br /><br />
                ...
                if ($db_con) {
                    ...
                    $old_log	= $log["real_log"];  //  get previous real-log data
                    $msg 		= $old_log."".$msg;  // build updated real-log data
                    $msg 		= $db_con->real_escape_string($msg); //  protect the database
