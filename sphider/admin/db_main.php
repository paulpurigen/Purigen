<?php
    ...
    echo "    <form name='dbform1123' id='dbform1123' method='post' action='admin.php?f=98'>
    ...
    echo "<br />
            <div>
            <form name='dbselect121' id='dbselect121' action=\"admin.php?f=98\" method=\"get\">
    ...
    echo "<div class='submenu cntr'>Backup &amp; Restore for database ".$db.":&nbsp;'".$database."'</div>
            ";
    if($is_first==1){
        echo "<form name='make_backup' id='make_backup' action=\"admin.php?f=98\" method=\"get\">
                <table width='90%'>
                    <tr>
...
*/
    ...
    if ($tables) {
        ...
        echo " </table>
            <form name='optimize' id='optimize' method='get' action='admin.php?f=98'>
                <p class='tblhead'>
                <input type='hidden' name='f' value='database' />
                <input type='hidden' name='db' value='".$db."' />
