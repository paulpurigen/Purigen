...
<div id="container">
    ...
    <div class="main-news">
        ...
        <dl>
            ...
            <dd><?=$webhelper->GetMonthShortName($NewsViewData["month"])?> <?=$NewsViewData["day"]?>, <?=$NewsViewData["year"]?></dd>
        ...
        <article>
            ...
            <a href="/news-events/news/view.php?pkid=<?=$NewsViewData["pkid"]?>"><i class="fas fa-chevron-circle-left"></i></a>

            <p><?=$NewsViewData["maintitle"]?></p>

            <a href="/news-events/news/view.php?pkid=<?=$NewsViewData["pkid"]?>"><i class="fas fa-chevron-circle-right"></i></a>

        </article>



        <div class="main-news-more"><a href="/news-events/news/list.php">READ MORE</a></div>
    ...
    <div class="main-workflow">
        ...
        <div class="main-workflow-inner">
                ...
                <img src="/images/workflow-purigen-ffpe.svg" width="83%" alt="Purigen FFPE Workflow">
