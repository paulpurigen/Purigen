...
<div id="container">
    ...
    <div class="main-news">
        ...
        <dl>
            <dt>PRESS RELEASE</dt>
            <dd><?=$webhelper->GetMonthShortName($row["month"])?> <?=$row["day"]?>, <?=$NewsViewData["year"]?></dd>
        </dl>
        <article>
        ...
        <div class="main-news-more"><a href="/news-events/news/view.php?pkid=<?=$row["pkid"]?>">READ MORE</a></div>
        <script>
            console.log($row);
            console.log($row["maintitle"]);
        </script>
        <?php
                }
            }
