...
<meta name="description" content="Purigen Biosystems is revolutionizing DNA extraction and nucleic acid purification for life science research with its novel isotachophoresis (ITP) technology." />
...
<meta content="The Purigen Ionic™ Purification System isolates pure, native, nucleic acid without the use of harsh lysis steps or chaotropic salts." property="og:description">
<meta content="The Purigen Ionic™ Purification System isolates pure, native, nucleic acid without the use of harsh lysis steps or chaotropic salts." name="twitter:description">
...
$sql = "select pkid, type, startyear, startmonth, startday, endyear, endmonth, endday, maintitle, subtitle, url, location1, location2, booth, thumbnail1 
        from events where status = 1 order by startyear asc, startmonth asc, startday asc limit 4";
...
<div id="container">
    ...
    <div class="main-visual" id="main-visual">
        <ul class="main-visual-slide" id="main-visual-slide">
            <li class="active">
                <video id="main-video1" playsinline autoplay muted="muted"><!--  loop> -->
                    <!-- <source id="main-video1-source" src="/videos/vid-purigen-ionic-dark-bg-test-01a.mp4" type="video/mp4"> -->
                </video>
                <article>
                    <h3>Purigen Biosystems</h3>
                    <h2>A Revolution in Nucleic Acid Purification</h2>
            ...
            <li>
                ...
                <article>
                    <h3>Visit Us at AMP 2019 - <span style="font-family: 'Forza-Bold'">BOOTH 3139</span></h3>
                    <h2>See the new Ionic<span style="font-family: 'Forza-Light'; font-size: 28px;">&trade;</span> Purification System at AMP</h2>
                    <p>November 7–9 &nbsp; | &nbsp; Baltimore Convention Center</p>
        ...
        <script>
            ...
            /* JavaScript */
              ...
              var vid = document.getElementById("main-video1");
              var source = document.createElement("source");
              source.id = "main-video1-source";
              source.setAttribute("type", "video/mp4");
              // vid.appendChild(source);
              vid.innerHTML(source);
                             
              if (w.matches) {
                vid.pause();
                source.removeAttribute("src");
                source.setAttribute("src", "/videos/vid-m-purigen-slide-01.mp4");
                vid.load();
                vid.play();
              } else {
                vid.pause();
                source.removeAttribute("src");
                source.setAttribute("src", "/videos/vid-purigen-ionic-dark-bg-test-01a.mp4");
                vid.load();
                vid.play();
              }
            ...
            window.addEventListener("resize", function(){
              var w = window.matchMedia("(max-width: 640px)");
              var vid = document.getElementById("main-video1");
              var source = document.getElementById("main-video1-source");
              
              if (w.matches) {
                vid.pause();
                source.src = "/videos/vid-m-purigen-slide-01.mp4";
                vid.load();
                vid.play();
              } else {
                vid.pause();
                source.src = "/videos/vid-purigen-ionic-dark-bg-test-01a.mp4";
                vid.load();
                vid.play();
              }
            });
    ...
    <div class="feature-bar"><img src="images/svg/icon-purigen-white-square.svg" width="20" style="opacity:0.5; margin-right:10px"> &nbsp; VISIT US at AMP 2019 <span style="font-family:'Forza-Light'">&nbsp; - &nbsp; Baltimore, MD &nbsp; - &nbsp; November 7–9 &nbsp; &nbsp; | &nbsp; &nbsp;</span> BOOTH 3139</div>
    ...
    <div class="main-movie">
        <div class="main-movie-inner">
            ...
            <div class="main-movie-section">
                ...
                <iframe class="elementor-video-iframe" allowfullscreen="" src="https://www.youtube.com/embed/ie7PUn3rRCU?feature=oembed&amp;start&amp;end&amp;wmode=opaque&amp;loop=0&amp;controls=1&amp;mute=0&amp;rel=0&amp;modestbranding=0"></iframe>
