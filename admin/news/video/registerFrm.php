...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php'); ?>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/news/video/register.php" enctype="multipart/form-data">
                ...
                <table class="board_write">
                    ...
                    <tr>
                        <th>youtube url</th>
                        <td><input type="text" name="videourl" id="videourl" maxlength="500" style="width:350px"></td>
                    </tr>
                </table>
                <!-- //board_write -->
            </form>
