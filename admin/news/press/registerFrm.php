...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php')?>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/news/press/register.php" enctype="multipart/form-data">
                ...
                <table class="board_write">
                    ...
                    <tr>
                        <th>source</th>
                        <td><input type="text" name="source" id="source" maxlength="100" style="width:350px"></td>
                    </tr>
                    <tr>
                        <th>url</th>
                        <td><input type="text" name="url" id="url" maxlength="200" style="width:350px"></td>
                    </tr>
                    <tr>
                        <th>main title</th>
                    ...
                    <tr>
                        <th>body</th>
                        <td><textarea name="body" id="body" style="width:516px;height:280px"></textarea></td>
                    </tr>
                    <tr>
            ...
            <div class="form_submit l_clear">
                ...
                <!--div class="side side-right">
                    <a href="#" class="bt bt-navy">delete</a>
                </div-->
            </div>
            <!-- //form_submit -->
