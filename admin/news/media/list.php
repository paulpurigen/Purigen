...
$dbhelper->dbOpen();
$sql = "select pkid, year, month, day, maintitle, source, status, thumbnail from media ";
if($searchKey != "")
{
...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php'); ?>
    <script type="text/javascript">
        ...
        {
            location.href = "/admin/news/media/modifyFrm.php?pkid="+pkid+"&page=<?=$page.$Parameter?>";
        }
        ...
        function excute()
        {
            ...
            if(ischecked())
            {
                ...
                {
                    f.action = "/admin/news/media/publish.php";
                    f.submit();
                }else if($('#excute').val() == 3)
                {
                    f.action = "/admin/news/media/unpublish.php";
                    f.submit();
                }
            }else
            {
        ...
        function duplicate(pkid)
        {
            ...
            {
                location.href = "/admin/news/media/duplicate.php?pkid="+pkid+"&page=<?=$page.$Parameter?>";
            }
        }
    </script>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form name="searchFrm" method="get" action="/admin/news/media/list.php">
                <input type="hidden" name="order" value="<?=$order?>"/>
                <div class="form_search">
                    <input type="text" name="searchKey" value="<?=$searchKey?>"> <a href="javascript:search();" class="bt bt-green">search</a>
                    <a href="/admin/news/media/registerFrm.php" class="bt bt-green add_new">ADD NEW</a>
                </div>
                <!-- //form_search -->
            </form>
