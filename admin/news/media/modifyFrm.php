...
$dbhelper->dbOpen();
$sql = "select pkid, year, month, day, source, url, maintitle, subtitle, body, thumbnail, filename, orgfilename, status from media where pkid = $pkid ";
$ViewData = $dbhelper->RunSQLReturnOneRow($sql);
$dbhelper->dbClose();

if($webhelper->isNull($ViewData))
    $webhelper->AlertMessageAndGo("Error. Please try again.", "/admin/news/media/list.php" . $Parameter);
?>
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php')?>
    ...
    <script type="text/javascript">
        ...
        function del()
        {
            ...
            {
                f.action = "/admin/news/media/delete.php";
                f.submit();
            }
        }
    </script>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/news/media/modify.php" enctype="multipart/form-data">
                        ...
                        <td>
                            ...
                            <?php
                                if( $ViewData["thumbnail"] != "" )
                                {
                                    ...
                                    echo "<img src=\"/files/media/" . $ViewData["thumbnail"] . "\">";
