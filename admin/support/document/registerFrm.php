...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php'); ?>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/support/document/register.php" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="type" id="type">
                                ...
                                <option value="1">SPECIFICATION SHEETS</option>
                                <option value="2">USER GUIDES</option>
                                <option value="3">SITE PREP GUIDES</option>
                                <option value="4">PROTOCOLS</option>
                                <option value="5">PRODUCT INSERTS</option>
                                <option value="6">SAFETY DATA SHEETS</option>
