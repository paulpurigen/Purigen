...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php'); ?>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/resources/literature/register.php" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="type" id="type">
                                ...
                                <option value="3">APP NOTES</option>
                                <option value="4">POSTERS</option>
                                <option value="5">INFOGRAPHICS</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
