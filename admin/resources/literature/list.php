...
$dbhelper->dbOpen();
$sql = "select pkid, type, title, status from literature";
if($searchKey != "")
{
...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php'); ?>
    <script type="text/javascript">
        ...
        {
            location.href = "/admin/resources/literature/modifyFrm.php?pkid="+pkid+"&page=<?=$page.$Parameter?>";
        }
        ...
        function excute()
        {
            ...
            if(ischecked())
            {
                ...
                {
                    f.action = "/admin/resources/literature/publish.php";
                    f.submit();
                }else if($('#excute').val() == 3)
                {
                    f.action = "/admin/resources/literature/unpublish.php";
                    f.submit();
                }
            }else
            {
        ...
        function duplicate(pkid)
        {
            ...
            {
                location.href = "/admin/resources/literature/duplicate.php?pkid="+pkid+"&page=<?=$page.$Parameter?>";
            }
        }	
    </script>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form name="searchFrm" method="get" action="/admin/resources/literature/list.php">
                <input type="hidden" name="order" value="<?=$order?>"/>
                <div class="form_search">
                    <input type="text" name="searchKey" value="<?=$searchKey?>"> <a href="javascript:search();" class="bt bt-green">search</a>
                    <a href="/admin/resources/literature/registerFrm.php" class="bt bt-green add_new">ADD NEW</a>
                </div>
                <!-- //form_search -->
            </form>
