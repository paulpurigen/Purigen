...
$dbhelper->dbOpen();
$sql = "select pkid, year, month, day, title, body, thumbnail1, thumbnail2, filename, orgfilename, updatedate from literature where pkid = $pkid ";
$ViewData = $dbhelper->RunSQLReturnOneRow($sql);
$dbhelper->dbClose();

if($webhelper->isNull($ViewData))
    $webhelper->AlertMessageAndGo("Error. Please try again.", "/admin/resources/literature/list.php" . $Parameter);
?>
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php')?>
    ...
    <script type="text/javascript">
        ...
        function del()
        {
            ...
            {
                f.action = "/admin/resources/literature/delete.php";
                f.submit();
            }
        }
    </script>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/resources/literature/modify.php" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="type" id="type">
                                <option value="0" <?=$webhelper->MakeSelectedValue("0", $ViewData["month"])?>>- select one -</option>
                                <option value="1" <?=$webhelper->MakeSelectedValue("1", $ViewData["month"])?>>BROCHURES</option>
                                <option value="2" <?=$webhelper->MakeSelectedValue("2", $ViewData["month"])?>>FLYERS</option>
                                <option value="3" <?=$webhelper->MakeSelectedValue("3", $ViewData["month"])?>>APP NOTES</option>
                                <option value="4" <?=$webhelper->MakeSelectedValue("4", $ViewData["month"])?>>POSTERS</option>
                                <option value="5" <?=$webhelper->MakeSelectedValue("5", $ViewData["month"])?>>INFOGRAPHICS</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                                if( $ViewData["thumbnail1"] != "" )
                                {
                                    ...
                                    echo "<img src=\"/files/literature/" . $ViewData["thumbnail1"] . "\">";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                                ...
                                {
                                    echo "<div style=\"margin-top:10px\">";
                                    echo "<img src=\"/files/literature/" . $ViewData["thumbnail2"] . "\">";
