...
$dbhelper->dbOpen();
$sql = "select pkid, year, month, day, title, body, thumbnail1, thumbnail2, filename, orgfilename, updatedate from sheets where pkid = $pkid ";
$ViewData = $dbhelper->RunSQLReturnOneRow($sql);
$dbhelper->dbClose();

if($webhelper->isNull($ViewData))
    $webhelper->AlertMessageAndGo("Error. Please try again.", "/admin/resources/sheets/list.php" . $Parameter);
?>
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php')?>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form method="post" name="regFrm" action="/admin/resources/sheets/modify.php" enctype="multipart/form-data">
                        ...
                        <td>
                            ...
                            <?php
                                if( $ViewData["thumbnail1"] != "" )
                                {
                                    ...
                                    echo "<img src=\"/files/sheets/" . $ViewData["thumbnail1"] . "\">";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                                ...
                                {
                                    echo "<div style=\"margin-top:10px\">";
                                    echo "<img src=\"/files/sheets/" . $ViewData["thumbnail2"] . "\">";
