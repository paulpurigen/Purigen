...
$dbhelper->dbOpen();
$sql = "select pkid, year, month, day, title, status from sheets";
if($searchKey != "")
{
...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/include/header.php'); ?>
    <script type="text/javascript">
        ...
        function del(pkid)
        {
            ...
            if(confirm("Are you sure you want to delete this record?"))
            {
                ...
                f.action = "/admin/resources/sheets/delete.php";
                f.submit();
            }
        }
        ...
        {
            location.href = "/admin/resources/sheets/modifyFrm.php?pkid="+pkid+"&page=<?=$page.$Parameter?>";
        }
        ...
        function excute()
        {
            ...
            if(ischecked())
            {
                ...
                {
                    f.action = "/admin/resources/sheets/publish.php";
                    f.submit();
                }else if($('#excute').val() == 3)
                {
                    f.action = "/admin/resources/sheets/unpublish.php";
                    f.submit();
                }
            }else
            {
        ...
        function duplicate(pkid)
        {
            ...
            {
                location.href = "/admin/resources/sheets/duplicate.php?pkid="+pkid+"&page=<?=$page.$Parameter?>";
            }
        }	
    </script>
    ...
    <div id="container">
        ...
        <div id="contents">
            ...
            <form name="searchFrm" method="get" action="/admin/resources/sheets/list.php">
                <input type="hidden" name="order" value="<?=$order?>"/>
                <div class="form_search">
                    <input type="text" name="searchKey" value="<?=$searchKey?>"> <a href="javascript:search();" class="bt bt-green">search</a>
                    <a href="/admin/resources/sheets/registerFrm.php" class="bt bt-green add_new">ADD NEW</a>
                </div>
                <!-- //form_search -->
            </form>
